	            				...
	            				<div class="mdTextWrap">
	            					<p id="p_friend">
	            						<a href="myPage?mem_num=${friends.mem_num}"><strong>${friends.mem_name}<span> (${friends.mem_id})</span></strong></a>
	         							<input class="innerButton" id="mdDelete" type="button" value="삭제" onclick="deleteFriend(${sessionScope.mvo.mem_num},${friends.mem_num},'myFriends')"/>
	         							<input class="innerButton" id="friendNoteBtn" type="button" value="&#9993;" onclick="replyNote(${friends.mem_num})"/>
	            					</p>
	            				</div>
	            			</li>
            			</c:forEach>
